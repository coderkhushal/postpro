...
exports.handleResetPasswordVerifyToken = exports.handleResetPassword = exports.handleLogin = exports.handlesignup = void 0;
const bcryptjs_1 = __importDefault(require("bcryptjs"));
const jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
const client_1 = require("@prisma/client");
const crypto_1 = __importDefault(require("crypto"));
const mailer_1 = require("../../service/mailer");
...
const handleResetPassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let response = yield mailer_1.Mailer.getinstance().sendMail(email, resetPasswordToken);
        if (response) {
...
//"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6OSwiaWF0IjoxNzE3MTM2NzAwLCJleHAiOjE3MTcyMjMxMDB9.eaDabfVAqmY46p9KsLO2opAY3t0-Ve84kypV7sSZxDg
